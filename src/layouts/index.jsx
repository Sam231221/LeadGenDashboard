...
import { IoHelpOutline, IoMenuOutline, IoPeopleOutline, IoSearchOutline, IoStatsChartOutline, IoStatsChartSharp } from "react-icons/io5";
...
const index = ({ children }) => {
    ...
    return (
        <div className="relative w-full">
            ...
            {/* Sidebar */}
            <div className={`${isOpen ? "w-[244px] " : 'w-[65px]'} h-screen navigation fixed left-0 bg-white border-white`}>
                <div className='group w-full gap-1 flex items-center text-white'>
                    ...
                    <Link className='flex' to="/">
                        ...
                        <span className="text-2xl text-primaryTextColor ml-2 font-bold py-3">LeadGen</span>
                ...
                <ul className='w-full mt-5 md:active:w-[244px]'>
                    ...
                    <li
                        className={`${splitLocation[1] === "" ? 'active bg-[#EEF2FA]' : ''} my-2 relative group w-full rounded-tl-full rounded-bl-full hover:bg-[#EEF2FA]`}>
                        <Link to='/'
                    ...
                    <li
                        className={`${splitLocation[1] === "reports" ? 'active bg-[#EEF2FA]' : ''}  my-2 relative group w-full rounded-tl-full rounded-bl-full hover:bg-[#EEF2FA]`}
                    >
                    ...
                    <li
                        className={`${splitLocation[1] === "customers" ? 'active bg-[#EEF2FA]' : ''} my-2 relative group w-full rounded-tl-full rounded-bl-full hover:bg-[#EEF2FA]`}
                    >
                    ...
                    <li
                        className={`${splitLocation[1] === "products" ? 'active bg-[#EEF2FA]' : ''} my-2 relative group w-full rounded-tl-full rounded-bl-full hover:bg-[#EEF2FA]`} >
                    ...
                    <li
                        className={`${splitLocation[1] === "help" ? 'active bg-[#EEF2FA]' : ''} my-2 relative group w-full rounded-tl-full rounded-bl-full hover:bg-[#EEF2FA]`}>
            ...
            {/* Main */}
            <div className={`${isOpen ? "w-[calc(100%-244px)] left-[244px]" : "w-[calc(100%-65px)] left-[65px] "} transition duration-500 ease-out absolute  min-h-screen bg-primaryBgColor`}>
                <div className="topbar z-10 sticky top-0 bg-white w-full h-[60px] flex justify-between items-center">
                    <div className="flex gap-3 items-center">
                        {/* Hamburger */}
                        <IoMenuOutline onClick={toggleMenu} className='w-[30px] h-[30px] cursor-pointer hidden sm:block' />
