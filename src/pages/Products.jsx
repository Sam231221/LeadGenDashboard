  ...
  const loadProductData = async (
    ...
    switch (opType) {
      case "search":
        ...
        return await axios
          .get(
            `http://localhost:5000/products?q=${query}&_start=${start}&_end=${end}`
          )
          .then((response) => {
      ...
      case "sort":
        ...
        return await axios
          .get(
            `http://localhost:5000/products?_sort=${filterOrSortValue}&_order=asc&_start=${start}&_end=${end}`
          )
          .then((response) => {
            setProducts(response.data);
            setCurrentPage(currentPage + increase);
      ...
      case "filter":
        ...
        return await axios
          .get(
            `http://localhost:5000/products?status=${filterOrSortValue}&_order=asc&_start=${start}&_end=${end}`
          )
          .then((response) => {
            setProducts(response.data);
            setCurrentPage(currentPage + increase);
    ...
    <div className="p-5">
      <div className="mb-5">
        ...
        <p className="text-[var(--sectionMiniColor)] font-bold  text-xs">
          Home /{" "}
          <span className="text-[var(--sectionParagraphColor)] ">Products</span>
        </p>
      </div>
      <div className="shadow-lg bg-[var(--primaryBgColor)] rounded p-5">
        <div className="flex flex-col sm:flex-row gap-3 items-center justify-between mt-2">
          <div className="text-xs flex items-center gap-3">
            <span className="ml-1 text-[var(--primaryParagraphColor)]">
              Filter By Status:
            </span>
            <select
          ...
          <button
            ...
            className="flex text-[var(--primaryParagraphColor)] items-center border-[1px] hover:border-[var(--sectionTitleColor)] hover:text-[var(--sectionTitleColor)] gap-2 border-black-500 p-2"
          >
          ...
          <table className="table border border-[var(--ternaryBgColor)] w-full mt-4 mb-2">
            ...
            <tbody>
              {products.map((product, i) => (
                <tr key={i + 1}>
                  <td className="p-2 text-sm text-[var(--primaryParagraphColor)]">
                    <a
                  ...
                  <td className="p-2 text-xs text-[var(--secondaryParagraphColor)]">
                    <span
                      className={`${
                  ...
                  <td className="p-2 text-xs text-gray-700">
                    <div className="flex gap-3">
                      <div
                        onClick={(e) => handleUpdateModalOnClick(e)}
                        id={product.id}
                        className="bg-[var(--secondaryBgColor)] hover:bg-[var(--LinkHoverColor)] p-2 cursor-pointer"
                      >
      ...
      <div
        className={`${
          updatemodalOpen ? "absolute" : "hidden"
        } top-0  bg-black/30 left-0 z-10 w-full h-screen`}
      >
        <div className="flex items-center justify-center h-full ">
          <div className="w-[600px] py-5 max-h-[600px] bg-white p-3 drop-shadow-lg relative">
            ...
            <form
              ...
              className="grid grid-cols-2 gap-3 px-3 mt-3"
            >
              <div className="flex flex-col text-lg col-span-2">
                ...
                <input
                  ...
                  className="text-sm border-b-[1px] border-forteryTextColor px-2 py-1 outline-none focus:border-sky-500"
                />
              </div>
              ...
              <div className="flex flex-col text-lg">
                ...
                <select
                  ...
                  className="border-b-[1px] text-sm border-forteryTextColor outline-none px-2 py-1 focus:border-sky-600"
                  id=""
                >
                  <option value="">-------</option>
                  <option value="Draft">Draft</option>
              ...
              <button
                type="submit"
                className="border-none mt-4 text-white flex items-center gap-3 bg-secondaryTextColor py-2 px-3 rounded hover:bg-primaryTextColor hover:text-white transition-all duration-500 ease-out "
              >
            ...
            <div
              onClick={handleUpdateModalOnClick}
