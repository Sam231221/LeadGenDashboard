            ...
            <div className='grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 '>
                <div className='grid gap-3 grid-cols-1 sm:grid-cols-4 sm:col-span-2  lg:grid-cols-3'>
                    ...
                    <div className='shadow-lg bg-white rounded col-span-4 sm:col-span-2 lg:col-span-1  p-5'>
                        ...
                        <div className='flex justify-between items-center'>
                            <h2 className='font-semibold text-primaryTextColor text-lg'>Sales |<span className='text-xs text-forteryTextColor'>Today</span></h2>
                        ...
                        <div className='flex items-center mt-5'>
                            ...
                            <div className='flex ml-3 flex-col'>
                                <h2 className='text-2xl font-bold text-primaryTextColor'>145</h2>
                    ...
                    <div className='shadow-lg bg-white rounded col-span-4 sm:col-span-2 lg:col-span-1 p-5'>
                        <div className='flex justify-between  items-center'>
                            <h2 className='font-semibold text-primaryTextColor text-lg'>Revenue |<span className='text-xs text-forteryTextColor'>This month</span></h2>
                            <BiDotsHorizontal className='text-forteryTextColor' />
                        </div>
                        ...
                        <div className='flex items-center mt-5'>
                            ...
                            <div className='flex ml-3 flex-col'>
                                <h2 className='text-2xl font-bold text-primaryTextColor'>$3,455</h2>
                    ...
                    <div className='shadow-lg bg-white rounded col-span-4 sm:col-span-4 lg:col-span-1 p-5'>
                        <div className='flex justify-between items-center'>
                            <h2 className='font-semibold text-primaryTextColor text-lg'>Customers |<span className='text-xs text-forteryTextColor'>This month</span></h2>
                            <BiDotsHorizontal className='text-forteryTextColor' />
                        </div>
                        ...
                        <div className='flex items-center mt-5'>
                            ...
                            <div className='flex ml-3 flex-col'>
                                <h2 className='text-2xl font-bold text-primaryTextColor'>1244</h2>
                    ...
                    <div className='shadow-lg bg-white rounded col-span-4  p-5'>
                        <div className='flex justify-between items-center mb-3'>
                            <h2 className='font-semibold text-primaryTextColor text-lg'>Reports  <span className='text-xs text-forteryTextColor'>| Today</span></h2>
                            <BiDotsHorizontal className='text-forteryTextColor' />
                        </div>
                        <AreaChart2 />
                    </div>
                    ...
                    <div className='shadow-lg bg-white rounded col-span-4 p-5'>
                        <div className='flex  justify-between items-center'>
                            <h2 className='font-semibold text-primaryTextColor text-lg'>Recent Sales | <span className='text-xs text-forteryTextColor'>Today</span></h2>
                            <BiDotsHorizontal className='text-forteryTextColor' />
                        </div>
                            ...
                            <table className='table border-collapse w-full mt-4 mb-2'>
                                <thead className='bg-secondaryBgColor '>
                                    <tr>
                                        ...
                                        <th className='p-2 text-xs font-semibold tracking-wide text-left'>Method</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {products.map((product, i) => (
                                        <tr key={i + 1}>
                                            ...
                                            <td className='p-2 text-xs text-gray-700'>{product.customer}</td>
                                            <td className='p-2 text-xs text-gray-700'>
                                                <a className='text-primaryTextColor hover:text-secondaryTextColor' href="#">{product.product}</a>
                                            </td>
                                            <td className='p-2 text-xs text-gray-700'>${product.price}</td>
                                            <td className='p-2 text-xs text-gray-700'>
                                                {product.method}
                                            </td>
                                        </tr>
                    ...
                    <div className='shadow-lg bg-white rounded col-span-4 p-5'>
                        <div className='flex justify-between items-center'>
                            <h2 className='font-semibold text-primaryTextColor text-lg'>Top Selling | <span className='text-xs text-forteryTextColor'>Today</span></h2>
                            <BiDotsHorizontal className='text-forteryTextColor' />
                        </div>
                        ...
                        <div className='py-2 overflow-y-auto'>
                                        ...
                                        <tr key={i + 1}>
                                            <td className='p-2 text-xs text-gray-700'>
                                                <a className='text-primaryTextColor hover:text-secondaryTextColor' href="#">
                                                    <img src={product.img} className='object-contain w-10 h-10' alt="" />
                                                </a>
                                            </td>
                                            <td className='p-2 text-xs text-gray-700'>{product.product}</td>
                                            <td className='p-2 text-xs text-gray-700'>
                                                <a className='text-primaryTextColor hover:text-secondaryTextColor' href="#">${product.price}</a>
                                            </td>
                                            <td className='p-2 text-xs text-gray-700'>{product.sold}</td>
                                            <td className='p-2 text-xs text-gray-700'>
                                                ${product.revenue}
                                            </td>
                                        </tr>
                            ...
                            <p className='text-xs p-2 border-t-2'>Showing 1 to 3 of 3 entries</p>
                        </div>
                ...
                <div className='gap-3 col-span-3 md:col-span-4 lg:col-span-1 '>
                    ...
                    <div className='shadow-lg bg-white rounded p-5'>
                        <div className='flex justify-between items-center'>
                            <h2 className='font-semibold text-primaryTextColor text-lg'>Recent Activity | <span className='text-xs text-forteryTextColor'>Today</span></h2>
                            <BiDotsHorizontal className='text-forteryTextColor' />
                        </div>
                    ...
                    <div className='shadow-lg bg-white rounded p-5 mt-4'>
                        <div className='flex justify-between items-center'>
                            <h2 className='font-semibold text-primaryTextColor text-lg'>Budegt Report | <span className='text-xs text-forteryTextColor'>This month</span></h2>
                            <BiDotsHorizontal className='text-forteryTextColor' />
                        </div>
                    ...
                    <div className='shadow-lg bg-white rounded p-5 mt-4'>
                        <div className='flex justify-between items-center'>
                            <h2 className='font-semibold text-primaryTextColor text-lg'>Wesbite Traffic | <span className='text-xs text-forteryTextColor'>This month</span></h2>
                            <BiDotsHorizontal className='text-forteryTextColor' />
                        </div>
                    ...
                    <div className='shadow-lg bg-white rounded p-5 mt-4'>
                        <div className='flex justify-between items-center'>
                            <h2 className='font-semibold text-primaryTextColor text-lg'>News & Updates | <span className='text-xs text-forteryTextColor'>This month</span></h2>
                            <BiDotsHorizontal className='text-forteryTextColor' />
                        </div>
